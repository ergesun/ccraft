...
#ifndef CCRAFT_NET_CORE_IMESSAGE_H
#define CCRAFT_NET_CORE_IMESSAGE_H
...
namespace std {
    template<>
    struct hash<ccraft::net::Message::Id> {
        size_t operator()(const ccraft::net::Message::Id &id) const {
...
#endif //CCRAFT_NET_CORE_IMESSAGE_H
