...
ServerInternalMessenger::ServerInternalMessenger(CreateServerInternalMessengerParam &createParam) :
    ...
    net::NssConfig nc(net::SocketProtocol::Tcp, sspNat, createParam.port, net::NetStackWorkerMgrType::Unique, m_pMemPool, std::bind(&INodeInternalRpcHandler::OnRecvRpcReturnResult, this, std::placeholders::_1),
    connTimeout);
