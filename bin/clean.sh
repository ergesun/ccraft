...
function print_usage {
    ...
    echo_yellow "  -gen  \t clean thrift gen cpp."
...
do
    if [ "$p" = "-gen" ]; then
        echo "cleaning thrift gen..."
        rm -rf ${BIN_DIR}/../be/src/gen-cpp
    elif [ "$p" = "-conf" ]; then
...
rm -rf ${BIN_DIR}/access_control_center
